"""
Guardian Malaysia Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Guardian Malaysia.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/guardian-malaysia
"""
...
# Set your Web Scraper ID after building your Guardian Malaysia scraper:
# https://bright.cn/products/web-scraper/guardian-malaysia
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Guardian Malaysia scraper at: https://bright.cn/products/web-scraper/guardian-malaysia\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Guardian Malaysia product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Guardian Malaysia products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Guardian Malaysia category page.

    Example:
        results = discover_by_category("https://guardianmalaysia.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.guardianmalaysia.com/product/sample-item-123456",
        # Add more Guardian Malaysia product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "guardian-malaysia_prices.json"
    ...
    # cat_results = discover_by_category("https://guardianmalaysia.com/category/sample", limit=50)
